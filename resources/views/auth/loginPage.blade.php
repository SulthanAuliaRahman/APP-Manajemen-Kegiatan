    ...
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form>
            ...
            <div class="flex items-center justify-between">
                <button type="submit" class="bg-blue-400 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Login</button>
            </div>
            <div class="mt-4 text-center">
                <a href="/register" class="inline-block align-baseline font-bold text-sm text-blue-400 hover:text-blue-500">or Register</a>
            </div>
        </form>
    </div>
</body>
